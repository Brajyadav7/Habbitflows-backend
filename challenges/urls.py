...
urlpatterns = [
    ...
    path('api/challenges/<int:challenge_id>/delete',      views.delete_challenge,    name='delete_challenge'),
    path('api/challenges/search-users',                   views.search_users_for_invite, name='search_users_for_invite'),
]
